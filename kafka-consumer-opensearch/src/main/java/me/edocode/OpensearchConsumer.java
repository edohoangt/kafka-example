...
//        String connString = "https://c9p5mwld41:45zeygn9hy@kafka-course-2322630105.eu-west-1.bonsaisearch.net:443";
    ...
    public static void main(String[] args) throws IOException {
        ...
        try (opensearchClient; consumer) { // auto close when exceptions are thrown
            boolean clientExists = opensearchClient.indices()
                    .exists(new GetIndexRequest("wikimedia"), RequestOptions.DEFAULT);

            if (!clientExists) {
                CreateIndexRequest createIndexRequest = new CreateIndexRequest("wikimedia");
                opensearchClient.indices().create(createIndexRequest, RequestOptions.DEFAULT);
                logger.info("New index has been created!");
            } else {
...
//                    String id = record.topic() + "_" + record.partition() + "_" + record.offset();
                    ...
                    try {
                        ...
                        // inefficient method: send every individual indexRequest
                ...
                if (bulkRequest.numberOfActions() > 0) {
                    ...
                    try {
                        Thread.sleep(1000); // accumulate more into batch
